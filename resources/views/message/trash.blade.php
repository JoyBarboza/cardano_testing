...
@section('message-page-content')
    <div class="inbox-body">
        <div class="inbox-header">
            <h1 class="pull-left">{{trans('message/trash.trash')}}</h1>
        </div>
                ...
                <tr>
                    <th colspan="3">
                        ...
                        <div class="btn-group input-actions">
                            <a class="btn btn-sm blue btn-outline dropdown-toggle sbold" href="javascript:;" data-toggle="dropdown"> {{trans('message/trash.actions')}}
                                <i class="fa fa-angle-down"></i>
                            </a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="javascript:;">
                                        <i class="fa fa-pencil"></i> {{trans('message/trash.mark_as_read')}}</a>
                                </li>
                                <li class="divider"> </li>
                                <li>
                                    <a href="javascript:;" name="deletemail">
                                        <i class="fa fa-trash-o"></i> {{trans('message/trash.delete')}} </a>
                                </li>
                            </ul>
                        </div>
                    </th>
