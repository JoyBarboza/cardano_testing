...
@section('message-page-content')
    <div class="inbox-body">
        <div class="inbox-header">
            <h1 class="pull-left">{{trans('message/inbox.Inbox')}}</h1>
        </div>
                ...
                <tr>
                    <th colspan="3">
                        ...
                        <div class="btn-group input-actions">
                            <a class="btn btn-sm blue btn-outline dropdown-toggle sbold" href="javascript:;" data-toggle="dropdown"> {{trans('message/inbox.actions')}}
                                <i class="fa fa-angle-down"></i>
                            </a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="javascript:;" name="markasread">
                                        <i class="fa fa-pencil"></i> {{trans('message/inbox.mark_read')}}</a>
                                </li>
                                <li class="divider"> </li>
                                <li>
                                    <a href="javascript:;" name="deletemail">
                                        <i class="fa fa-trash-o"></i> {{trans('message/inbox.delete')}} </a>
                                </li>
                            </ul>
                        </div>
                    </th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('td.inbox-small-cells > i').click(function(){
            ...
            $.ajax({
                type:'POST',
                url:base + '/admin/message/make-important',
        ...
        $('a[name=markasread]').click(function(){
            ...
            $.ajax({
                type:'post',
                url:base + '/admin/message/mark-as-read',
                data:{ids:ids},
                dataType:'json',
                success: function(result) {
                    if(result.status) {
