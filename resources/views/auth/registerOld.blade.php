                        ...
                        <form method="POST" action="{{ route('register') }}">
						  {{ csrf_field() }}
							...
							<div class="input-box mt-10  {{ $errors->has('referral_code') ? 'has-error' : 'has-feedback' }}">
								...
								<input id="referral_code" type="text"  name="referral_code" {{session('username')?' readonly':''}} value="{{session('username')?:old('referral_code')}}" autocomplete="off" placeholder="{{trans('auth/register.referral_code')}}">
