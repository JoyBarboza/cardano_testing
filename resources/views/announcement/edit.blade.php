        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('admin.announcement.update', $announcement->id) }}"  method="post">
                            ...
                            <div class="form-group {{ $errors->has('title')?'has-error':'' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input name="title" value ="{{ (request()->title!='')?request()->title:$announcement->title }}" type="text" class="form-control" placeholder="{{trans('announcement/create.enter_title')}}">
                                    </div>
                                    @if($errors->has('title'))
                            ...
                            <div class="form-group {{ $errors->has('description')?'has-error':'' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <textarea name="description" class="form-control">{{ (request()->description!='')?request()->description:$announcement->description }}</textarea>
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="1" {{$announcement->status}} @if($announcement->status==1) selected @endif>{{trans('announcement/create.enable')}}</option>
                                            <option value="0" {{$announcement->status}} @if($announcement->status==0) selected @endif>{{trans('announcement/create.disable')}}</option>
                                        </select>
                                    </div>
