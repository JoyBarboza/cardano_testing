    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow" href="javascript:void(0)" style="cursor: default">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="6">{{ round($usdBalance, 8) }}</span>
                    </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 green-soft" href="javascript:void(0)" style="cursor: default">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="6">{{ round($usdDeposit,8) }}</span>
                    </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 blue-dark" href="javascript:void(0)" style="cursor: default">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="549">{{ round($usdWithdraw,8) }}</span>
                    </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow-gold" href="javascript:void(0)" style="cursor: default">
                <div class="visual">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup">
							@php $getPresale=App\Presale::active();
								$sold_coin=0; 
								if($getPresale->exists()) {
									$sold_coin = $getPresale->first()->remaining_volume;
								}
							@endphp
							{{ round($sold_coin, 8) }}</span>
                    </div>
                    <div class="desc"> {{env('TOKEN_NAME')}} {{trans('dashboard.BALANCE')}} </div>
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 purple" href="javascript:void(0)" style="cursor: default">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="6">{{ round($mscDeposit,8) }}</span>
                    </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow-crusta" href="javascript:void(0)" style="cursor: default">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="6">{{ round($mscWithdraw,8) }}</span>
                    </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 red" href="javascript:void(0)" style="cursor: default">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup">{{ $joinedTotal }}</span>
                    </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 blue-steel" href="javascript:void(0)" style="cursor: default">
                <div class="visual">
                    <i class="fa fa-users"></i>
                </div>
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="549">{{ $joinedYesterday }}</span>
                    </div>
                    <div class="desc"> {{trans('dashboard.JOINED_YESTERDAY')}}  </div>
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 green" href="javascript:void(0)" style="cursor: default">
                <div class="visual">
                    <i class="fa fa-users"></i>
                </div>
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="549">{{ $joinedLastMonth }}</span>
                    </div>
                    <div class="desc"> {{trans('dashboard.JOINED_LAST_MONTH')}}  </div>
                </div>
            </a>
        </div>
        <div class="col-md-12">
