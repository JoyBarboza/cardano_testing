...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/global/cardano/css/data-tables-bootstrap5-min.css') }}">
...
<body>
        ...
        <div class="row">
            <div class="col-lg-12 main_page">
                ...
                <div class="list_div my-4">
                    ...
                    <!-- =============== Data Table ===================== -->
                    <div class="cardno_datatable">
                        <table id="example" class="table table-striped custom-clr" style="width:100%">
                            <thead>
                                <tr>
                                    <th>EPOCH</th>
                                    <th>SLOTS</th>
                            ...
                            <tbody>
                                @php $i=1; @endphp
                                @foreach ($mint_explore as $c)
                                <?php 
                                    $randomBlock = mt_rand(10000000,99999999); 
                                    $randomTransaction = mt_rand(100000,999999); 
                                ?>
                                    <tr>
                                        <!-- <td><a class="table_link" href="table.html">Tiger Nixon</a></td> -->
                                        <td>
                                            <b><a class="table_link" href="{{url('en/nft/timeBlockchain_detail/'.encrypt($c['id']).'/'.$randomBlock.'/'.$randomTransaction)}}">{{$c->id}}</a></b>
                                        </td>

                                        <td>
                                            <b><a class="table_link" href="{{url('en/timeBlockchainExplore_detail/'.encrypt($c['id']).'/'.$randomBlock.'/'.$randomTransaction)}}">{{$randomBlock}}</a></b>
                                        </td>
                                        <td>
                                            <b><a class="table_link" href="{{url('en/timeBlockchainExplore_detail/'.encrypt($c['id']).'/'.$randomBlock.'/'.$randomTransaction)}}">{{$randomBlock}}</a></b>
                                        </td>
                                        <td>{{$c->created_at}}</td>
                                        <td>{{date("Y-m-d H:i:s", strtotime(date("Y-m-d H:i:s", strtotime($c->created_at)) . " + 5day"))}}</td>
                                        <td>{{$randomTransaction}}</td>
                                        <td>{{$randomTransaction}}</td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <script src="{{ asset('assets/global/cardano/js/bootstrap-bundle.js') }}"></script>
    <script>
