    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div  style="display: flex;">
                <h3 style="margin:10px;">FT Collection List</h3>
                <div class="" style="margin-left: auto;">
                    <a href="{{ route('nft.ft') }}" class="nav-link" style="margin-left: 25px; border:1px solid blue; border-radius:25px !important; padding:2px 15px;">Add FT</a>
                    
                    <a href="{{ route('nft.ft_delete') }}" class="nav-link" style="float: right; color: red; margin-left: 25px; border:1px solid red; border-radius:25px !important; padding:2px 15px;">Delete All</a>
                </div>
            </div>
                        ...
                        <div class="col-md-3">
                            <div class="alpha_card_game">    
                                <div class="alpha_card_game_hdng">
                                    <a href="{{ route('nft.ft_detail', encrypt($v['id'])) }}">
                                        <h4>{{$v['name']}}</h4>
                                    </a>
                                    @php 
