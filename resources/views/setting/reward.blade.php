...
@section('contents')
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <hr><h3 style="margin:10px;">Reward</h3><hr>
            <form method="POST" action="{{ route('admin.update_reward') }}" enctype="multipart/form-data" data-parsley-validate>
                {{ csrf_field() }}
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card-widget white mint_form">
                                <div class="row margin-top-20">
                                    <div class="col-md-12">
                                        <h6 style="display: inline-block;" id="left-code">Time</h6>

                                        <input type='text' name="time" id="time" required data-parsley-required data-parsley-required-message="Enter time" value="{{$reward->time}}"/>
                                    </div>         

                                    <div class="col-md-12">
                                        <h6 style="display: inline-block;" id="left-code">Reward</h6>

                                        <input type='number' name="reward" id="reward" required data-parsley-required data-parsley-required-message="Enter reward amount" value="{{$reward->reward}}"/>
                                    </div>   

                                    <div class="col-md-12">
                                        <h6 style="display: inline-block;" id="left-code">Total User</h6>

                                        <input type='number' name="total_user" id="total_user" required data-parsley-required data-parsley-required-message="Enter the number of user" value="{{$reward->total_user}}" />
                                    </div>                         
                                </div>
                                 <div class="col-md-12">
