                    ...
                    <div class="Epoch_Summary_container">
                        ...
                        <div class="right_EpochDetails">
                            <div class="EpochSummary_infoPanel">
                                ...
                                <div class="EpochSummary_infoRow">
                                    <div class="EpochSummary_infoLabel">Total output</div>
                                        ...
                                        <?php
                                            if($explore_detail->type == 'ipfs' || $explore_detail->type == 'ft_ipfs'){
                                             ...
                                             <?php   }else{
                                                ...
                                                if(!empty($explore_detail->eth_amount) || $explore_detail->eth_amount != 0){
                                                    echo $explore_detail->eth_amount.' CSM';
                                                }else{
                        ...
                        <div class="right_EpochDetails">
                            <div class="EpochSummary_infoPanel">
                                ...
                                <div class="EpochSummary_infoRow">
                                    ...
                                    <div class="EpochSummary_infoVal">{{$explore_detail->transaction_id}}</div>
                                </div>
