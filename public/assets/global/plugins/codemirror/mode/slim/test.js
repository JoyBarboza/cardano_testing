...
(function() {
  ...
  MT("idShortcut",
     "[attribute&def #.htaccess] Hey There");

  MT("tagWithIdShortcuts",
     "[tag h1][attribute&def #.htaccess] Hey There");

  MT("classShortcut",
     "[attribute&qualifier .hello] Hey There");

  MT("tagWithIdAndClassShortcuts",
     "[tag h1][attribute&def #.htaccess][attribute&qualifier .hello] Hey There");
  ...
  MT("attributes",
     "[tag a]([attribute title]=[string \".htaccess\"]) [attribute href]=[string \"link\"]}");

  MT("multiLineAttributes",
     "[tag a]([attribute title]=[string \".htaccess\"]",
  ...
  MT("selectorRubyBlock",
     "[tag a][attribute&qualifier ..htaccess][operator&special =] [variable-2 @item]");

  MT("nestedRubyBlock",
      "[tag a]",
      "  [operator&special =][variable puts] [string \".htaccess\"]");
  ...
  MT("interpolationInHashAttribute",
     "[tag div]{[attribute id] = [string \"]#{[variable .htaccess]}[string _]#{[variable ting]}[string \"]} .htaccess");

  MT("interpolationInHTMLAttribute",
     "[tag div]([attribute title]=[string \"]#{[variable .htaccess]}[string _]#{[variable ting]()}[string \"]) Test");
})();
