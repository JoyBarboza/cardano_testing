            ...
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="example">
                    ...
                    <?php
                        $i = 1;
                        foreach ($getAllOfferLoyalty as $key => $value) { ?>
                           <tr>
                                <td><?php echo $i; ?></td>
                                <?php if (empty(base64_decode($this->uri->segment(3)))){?>
                                    <td><?php echo $value['vendor_name']; ?></td>
                                <?php }?>
                                <td><?php echo $value['name_offer']; ?></td>
                                <td>
                                  <?php if($value['type'] == 1){ 
                                    $method_type="Offer";
                                  }else{
                                ...
                                <td><?php echo $value['amout_discount']; ?></td>
                                <td><?php echo $value['offer_period']; ?></td>
                                <td>
                                ...
                                <td>
                                    <a  title="View" href="<?php echo base_url().'admin/offer_loyalty_view/'.base64_encode($value['id']);?>" class="btn btn-primary edit_add"><i class="fa fa-eye"></i></a>
                                </td>
