            ...
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="example">
                    ...
                    <?php
                        $i = 1;
                        foreach ($getAllPackage as $key => $value) { ?>
                           <tr>
                                <td><?php echo $i; ?></td>
                                <?php if (empty(base64_decode($this->uri->segment(3)))){?>
                                ...
                                <td>
                                  <?php if($value['group_method_type'] == 1){ 
                                ...
                                <td>
                                    <a  title="View" href="<?php echo base_url().'admin/group_view/'.base64_encode($value['id']);?>" class="btn btn-primary edit_add"><i class="fa fa-eye"></i></a>
                                </td>
