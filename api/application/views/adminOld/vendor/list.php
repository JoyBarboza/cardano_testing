                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="example">
                            ...
                            <tbody>
                                <?php
                                    $i = 1;
                                    if(!empty($getAllVendor)){
                                        foreach ($getAllVendor as $key => $value) { 
                                ?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                     <td><?=$value['name']?></td>
                                     <td>
                                        ...
                                        ?>
                                          <img class="" src="<?php echo $admin_img; ?>" alt="User Image" width="50px" height="50px;">
                                     ...
                                     <td><?=$value['dob']?></td>
                                     <td>
                                        <span class="btn btn-success remove_effect"><?=$value['plan_name']?></span>
                                     </td>
                                     <td>
                                        <?php
                                    ...
                                    <td>
                                        <a  title="View" href="<?php echo base_url().'admin/vendor_view/'.base64_encode($value['id']);?>" class="btn btn-primary edit_add"><i class="fa fa-eye"></i></a>
                                        ...
                                        <a  title="Delete" href="<?php echo base_url().'admin/vendor_delete/'.base64_encode($value['id']);?>" onclick="return deleteUser()" class="btn btn-danger">
