                ...
                <div class="row">
                    ...
                    <div class="tile-footer" style="border-top: none;margin-top: 7px;">
                        <button onclick="filterData();" class="btn btn-primary">Filter</button>
                            ...
                            <a href="<?php echo base_url('admin/user_resume_list'); ?>" class="btn btn-danger">Refresh</a>
                    </div>
                </div>
            </div>
                           ...
                           <tr>
                              ...
                              <td>
                                  <!--<a href ="<?php echo base_url().'admin/resume_detail/'.$key['id'];?>">View</a> -->
                                   ...
                                   <a href ="<?php echo base_url().'admin/user_resume_detail/'.base64_encode($key['user_id']);?>">View</a> 
                              </td>
                             <!--  <td class="center">
    ...
    function getSubSubCategory(sub_category_id){
     ...
     function filterData(){
        ...
        table = $('#example').DataTable({ 
            ...
            "ajax"          :  {
               "url"        : '<?php echo site_url("admin/ResumeController/filterUserResume"); ?>',
               "type"       : 'POST',
