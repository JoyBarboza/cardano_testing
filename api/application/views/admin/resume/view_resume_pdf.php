         ...
         <form class="usr_rsm_pdf" method="post" data-parsley-validate="" action="">
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <label for="email" style="font-family: sans-serif; font-size: 16px; font-weight: 600; width: 250px; margin-bottom: 8px; display: inline-block;">Recuriter Name :</label>

                    <label for="email" style="font-family: sans-serif; font-size: 16px; margin-bottom: 8px; display: inline-block;"><?= $getResumeDetail->r_name;?></label>
...
<?php if($this->uri->segment(2) != 'user_resume_detail') {?>
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <label for="name" style="font-family: sans-serif; font-size: 16px; font-weight: 600; width: 250px; margin-bottom: 8px; display: inline-block;">Organization Name :</label>

                    <label for="name" style="font-family: sans-serif; font-size: 16px; margin-bottom: 8px; display: inline-block;"><?= $getResumeDetail->organization_name;?></label>
