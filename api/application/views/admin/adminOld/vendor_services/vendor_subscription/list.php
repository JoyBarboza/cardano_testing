            ...
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="example">
                    ...
                    <?php
                        $i = 1;
                        foreach ($getAllSubscription as $key => $value) { ?>
                           <tr>
                                <td><?php echo $i; ?></td>
                                <?php if (empty(base64_decode($this->uri->segment(3)))){?>
                                    <td><?php echo $value['vendor_name']; ?></td>
                                <?php }?>
                                <td><?php echo $value['subcription_name']; ?></td>
                                <td>
                                    <i class="fa fa-gbp" aria-hidden="true"></i> <?php echo $value['price']; ?>
                                </td>
                                <td>
                                    <?php echo $value['period_subcription'].', '.$value['number_appointment_subcription'].', '.$value['hour_each_appointment']; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a  title="View" href="<?php echo base_url().'admin/subscription__view/'.base64_encode($value['id']);?>" class="btn btn-primary edit_add"><i class="fa fa-eye"></i></a>
                                </td>
