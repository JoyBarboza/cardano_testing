                        ...
                        foreach ($getAllCategory as $key) { 
                           ...
                           <tr>
                              ...
                              <td class="center">
                                  ...
                                  <a title="Edit" class="btn btn-primary edit_category" href="javascript:void(0);" data-category_name="<?php echo $key['name']; ?>" data-other_category_name="<?php echo $key['other_language_name']; ?>" data-image="<?php echo $key['image']; ?>" data-category_id="<?php echo $key['id']; ?>"><i class="fa fa-pencil"></i></a>
